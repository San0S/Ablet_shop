        ...
        <div class="apercu_panier">
            <?php 
                ...
                foreach ($caddieUser as $article) {
                    ...
                    if ($article['qte'] == 1) {
                        echo '<a href="./gestion_article_ajouter.php?fct=suppArticle&art='.$article['refart'].'&cad=on" class="qte">';
                        echo '<img src="../icons/delete.png" alt="supprimer" />';
                        echo '</a>';
                    } else {
                        echo '<a href="./gestion_article_ajouter.php?fct=redArticle&art='.$article['refart'].'&cad=on" class="qte">';
                    ...
                    echo '<a href="./gestion_article_ajouter.php?fct=ajoutArticle&art='.$article['refart'].'&cad=on" class="qte">';
                    echo '<img src="../icons/plus.png" alt="ajouter"/>';
                    echo '</a>';

                    echo '</div>';
                    echo '</div><a href="./gestion_article_ajouter.php?fct=suppArticle&art='.$article['refart'].'&cad=on" class="supprimer_article">Supprimer</a>';
                    echo '</div>';  
                }

                echo '<a href="./gestion_article_ajouter.php?fct=viderPanier&cad=on" class="link-block w-inline-block">';
