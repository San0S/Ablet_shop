            ...
            <div class="boutons">
                ...
                <?php
                    if ($_SESSION['login'] == "admin") {
                        echo '<a href="./admin/accueil_gestionnaire.php" name="gestion" value="gestion" class="accueil_bouton w-button">Fonctionnalités gestion</a>';
                    }
                ?>
            </div>
        ...
        <div class="apercu_panier">
            <?php 
                ...
                foreach ($caddieUser as $article) {
                    ...
                    if ($article['qte'] == 1) {
                        echo '<a href="./accueil.php?fct=suppArticle&art='.$article['refart'].'&cad=on" class="qte">';
                        echo '<img src="./icons/delete.png" alt="supprimer" />';
                        echo '</a>';
                    } else {
                        echo '<a href="./accueil.php?fct=redArticle&art='.$article['refart'].'&cad=on" class="qte">';
                    ...
                    echo '<a href="./accueil.php?fct=ajoutArticle&art='.$article['refart'].'&cad=on" class="qte">';
                    echo '<img src="./icons/plus.png" alt="ajouter"/>';
                    echo '</a>';

                    echo '</div>';
                    echo '</div><a href="./accueil.php?fct=suppArticle&art='.$article['refart'].'&cad=on" class="supprimer_article">Supprimer</a>';
                    echo '</div>';  
                }

                echo '<a href="./accueil.php?fct=viderPanier&cad=on" class="link-block w-inline-block">';
